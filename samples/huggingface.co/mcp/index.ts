...
export const mcpHuggingfaceToolsWithClient = (client: Promise<Client> | Client) => ({
  ...
  gr1_flux1_schnell_infer: gr1_flux1_schnell_inferToolWithClient(() => client)
} as const);
...
export const gr1_flux1_schnell_inferTool = gr1_flux1_schnell_inferToolWithClient(getMcpClient);
