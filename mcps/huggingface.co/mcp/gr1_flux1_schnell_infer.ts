...
export const gr1_flux1_schnell_inferToolWithClient = (
    ...
    inputSchema: z
      .object({
        prompt: z
          .string()
          .describe(
            "Approximately 60-70 words max - description of the image to generate.",
          )
          .optional(),
        seed: z
          .number()
          .describe("numeric value between 0 and 2147483647")
          .optional(),
        randomize_seed: z.boolean().default(true),
        width: z
          .number()
          .describe("numeric value between 256 and 2048")
          .default(1024),
        height: z
          .number()
          .describe("numeric value between 256 and 2048")
        ...
        num_inference_steps: z
          .number()
          .describe("numeric value between 1 and 16")
          .default(4),
      })
      .strict(),
